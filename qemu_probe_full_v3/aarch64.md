# QEMU Complete Architecture capability map: `aarch64`

- **Architecture Target:** `aarch64`
- **Binary Executable:** `C:\Users\chron\CURSOR-PROJECTS\aqemu\build_win\qemu-system-aarch64.exe`
- **Probed At:** 2026-07-31T08:32:54.089964
...
ast2700-evb          Aspeed AST2700 A2 EVB (Cortex-A35) (alias of ast2700a2-evb)
...
qcom-dc-scm-v1-bmc   Qualcomm DC-SCM V1 BMC (Cortex A7) (deprecated)
qcom-firework-bmc    Qualcomm DC-SCM V1/Firework BMC (Cortex A7) (deprecated)
...
sonorapass-bmc       OCP SonoraPass BMC (ARM1176) (deprecated)
...
virt                 QEMU 11.0 ARM Virtual Machine (alias of virt-11.0)
...
Available CPUs:
  ...
  ti925t
```
Total items listed: 37

## 3. Supported Devices & Busses (`-device help`)

```text
Controller/Bridge/Hub devices:
name "aspeed.pcie-root-port", bus PCI, desc "ASPEED PCIe Root Port"
