# QEMU Complete Architecture capability map: `mips64el`

- **Architecture Target:** `mips64el`
- **Binary Executable:** `C:\Users\chron\CURSOR-PROJECTS\aqemu\build_win\qemu-system-mips64el.exe`
- **Probed At:** 2026-07-31T08:33:01.128327
- **Fallback Machine Used for Context:** `malta`
...
loongson3-virt       Loongson-3 Virtualization Platform
magnum               MIPS Magnum
