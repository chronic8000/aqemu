...
s8000                Apple S8000 SoC (iPhone 6s Plus)
...
t8030                Apple T8030 SoC (iPhone 11)
...
virt                 QEMU 10.1 ARM Virtual Machine (alias of virt-10.1)
...
USB devices:
name "dwc2-usb-device", bus usb-bus
name "dwc3-usb-device", bus usb-bus
...
name "usb-tcp-remote", bus usb-bus, desc "QEMU USB Passthrough Device"
Storage devices:
...
name "apple-nvram", bus nvme-bus, desc "Apple NVRAM"
...
name "apple-spmi-baseband", bus spmi-bus, desc "Apple SPMI Baseband"
name "apple-spmi-pmu", bus spmi-bus, desc "Apple Dialog SPMI PMU"
name "apple-ssc", bus i2c-bus, desc "Apple SSC"
...
name "pmu-d2255", bus i2c-bus, desc "Apple PMU D2255"
