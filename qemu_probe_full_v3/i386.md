# QEMU Complete Architecture capability map: `i386`

- **Architecture Target:** `i386`
- **Binary Executable:** `C:\Users\chron\CURSOR-PROJECTS\aqemu\build_win\qemu-system-i386.exe`
- **Probed At:** 2026-07-31T08:32:58.944543
- **Fallback Machine Used for Context:** `pc`
...
name "ClearwaterForest-i386-cpu"
name "ClearwaterForest-v1-i386-cpu"
name "ClearwaterForest-v2-i386-cpu"
name "ClearwaterForest-v3-i386-cpu"
...
name "EPYC-Rome-v5-i386-cpu"
name "EPYC-Turin-i386-cpu"
name "EPYC-Turin-v1-i386-cpu"
name "EPYC-v1-i386-cpu"
name "EPYC-v2-i386-cpu"
name "EPYC-v3-i386-cpu"
name "EPYC-v4-i386-cpu"
name "EPYC-v5-i386-cpu"
name "GraniteRapids-i386-cpu"
name "GraniteRapids-v1-i386-cpu"
name "GraniteRapids-v2-i386-cpu"
name "GraniteRapids-v3-i386-cpu"
name "GraniteRapids-v4-i386-cpu"
name "GraniteRapids-v5-i386-cpu"
...
name "Icelake-Server-v7-i386-cpu"
...
name "SapphireRapids-v3-i386-cpu"
name "SapphireRapids-v4-i386-cpu"
name "SapphireRapids-v5-i386-cpu"
name "SapphireRapids-v6-i386-cpu"
name "SierraForest-i386-cpu"
name "SierraForest-v1-i386-cpu"
name "SierraForest-v2-i386-cpu"
name "SierraForest-v3-i386-cpu"
name "SierraForest-v4-i386-cpu"
name "SierraForest-v5-i386-cpu"
...
name "YongFeng-i386-cpu"
name "YongFeng-v1-i386-cpu"
name "YongFeng-v2-i386-cpu"
name "YongFeng-v3-i386-cpu"
Watchdog devices:
