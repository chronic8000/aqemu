...
pc-i440fx-11.0       Standard PC (i440FX + PIIX, 1996)
...
pc-q35-8.1           Standard PC (Q35 + ICH9, 2009) (deprecated)
...
Available CPUs:
  ...
  Cascadelake-Server-v6  Intel Xeon Processor (Cascadelake) [with MMIO/GDS/RFDS mitigation status]
  Cascadelake-Server-v7  Intel Xeon Processor (Cascadelake) [with MBEC enabled]
  ...
  ClearwaterForest-v4   Intel Xeon Processor (ClearwaterForest) [with MBEC enabled]
  ...
  DiamondRapids-v2      Intel Xeon Processor (DiamondRapids) [with MBEC enabled]
  ...
  EPYC-Genoa-v3         AMD EPYC-Genoa-v3 Processor
  ...
  EPYC-Milan-v4         AMD EPYC-Milan-v4 Processor
  ...
  EPYC-Turin-v2         AMD EPYC-Turin-v2 Processor
  ...
  GraniteRapids-v6      Intel Xeon Processor (GraniteRapids) [with GDS and RFDS mitigation status]
  GraniteRapids-v7      Intel Xeon Processor (GraniteRapids) [with MBEC enabled]
  ...
  Icelake-Server-v8     Intel Xeon Processor (Icelake) [with MMIO/GDS/RFDS mitigation status]
  Icelake-Server-v9     Intel Xeon Processor (Icelake) [with MBEC enabled]
  ...
  SapphireRapids-v7     Intel Xeon Processor (SapphireRapids) [with GDS and RFDS mitigation status]
  SapphireRapids-v8     Intel Xeon Processor (SapphireRapids) [with MBEC enabled]
  ...
  SierraForest-v6       Intel Xeon Processor (SierraForest) [with MBEC enabled]
  ...
  Skylake-Server-v6     Intel Xeon Processor (Skylake, IBRS, no TSX) [with MBEC enabled]
...
name "Cascadelake-Server-v6-x86_64-cpu"
name "Cascadelake-Server-v7-x86_64-cpu"
...
name "ClearwaterForest-v4-x86_64-cpu"
...
name "GraniteRapids-v6-x86_64-cpu"
name "GraniteRapids-v7-x86_64-cpu"
...
name "Icelake-Server-v8-x86_64-cpu"
name "Icelake-Server-v9-x86_64-cpu"
...
name "SapphireRapids-v7-x86_64-cpu"
name "SapphireRapids-v8-x86_64-cpu"
...
name "SierraForest-v6-x86_64-cpu"
...
name "Skylake-Server-v6-x86_64-cpu"
...
name "sp-mem", desc "SPM (Specific Purpose Memory) device"
name "ufs-lu", bus ufs-bus, desc "Virtual UFS logical unit"
```
Total items listed: 417
